...
static void setValues(CatalogRecord * record, const char * code, const char * designation,
        const char * unity, double basePrice, double sellingPrice, double rateOfVAT) {
    CatalogRecord_FieldProperties properties;
...
static void testValues(CatalogRecord * record, const char * code, const char * designation,
        const char * unity, double basePrice, double sellingPrice, double rateOfVAT) {
    ASSERT_EQUAL_STRING(record->code, code);
    ASSERT_EQUAL_STRING(record->designation, designation);
    ASSERT_EQUAL_STRING(record->unity, unity);
...
static void test_CatalogRecord_readWrite(void) {
    ...
    file = fopen("../catalogrecord-unittest.db", "wb");
    ...
    file = fopen("../catalogrecord-unittest.db", "rb");
...
void test_CatalogRecord(void) {
    test_CatalogRecord_accessors();
    test_CatalogRecord_readWrite();
}
