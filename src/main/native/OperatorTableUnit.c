...
static void test_OperatorTable_removeOperator(void) {
    ...
    ASSERT_EQUAL_STRING(OperatorTable_getName(table, OperatorTable_findOperator(table, "elle")),
            "elle");
    ASSERT_EQUAL_STRING(OperatorTable_getName(table, OperatorTable_findOperator(table, "lui")),
            "lui");
    ASSERT_EQUAL_STRING(OperatorTable_getName(table, OperatorTable_findOperator(table, "eux")),
            "eux");
...
void test_OperatorTable(void) {
    test_OperatorTable_createAndDestroy();
    test_OperatorTable_getAndSetOperator();
    test_OperatorTable_findOperator();
    test_OperatorTable_removeOperator();
    test_OperatorTable_loadAndSave();
}
