...
static GtkWidget * MainWindow_createStudentPanel(void) {
    ...
    label = gtk_label_new(STUDENT_NAMES);
    gtk_misc_set_alignment(GTK_MISC(label), 0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label, 1, 2, 0, 1, GTK_EXPAND | GTK_FILL, GTK_EXPAND
            | GTK_FILL, 5, 5);
    gtk_widget_show(label);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label, 1, 2, 1, 2, GTK_EXPAND | GTK_FILL, GTK_EXPAND
            | GTK_FILL, 5, 5);
    gtk_widget_show(label);
    ...
    gtk_misc_set_alignment(GTK_MISC(label), 0, 0.5);
    gtk_table_attach(GTK_TABLE(table), label, 1, 2, 2, 3, GTK_EXPAND | GTK_FILL, GTK_EXPAND
            | GTK_FILL, 5, 5);
    gtk_widget_show(label);
