...
static void DocumentEditor_loadData(DocumentEditor * documentEditor, int first) {
    ...
    for (i = 0; i < EDITOR_ROWCOUNT; ++i) {
        ...
        if (row == NULL) {
            ...
            sprintf(buf, "%.2f", (double) (row->quantity));
