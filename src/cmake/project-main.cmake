...
# Add the target
if(main_sources)
  add_executable( ${CMAKE_PROJECT_NAME} ${main_sources} ${main_sources_aux} )
else()
...
add_linker_flags_to_target( ${CMAKE_PROJECT_NAME} "-Wl,-O4,-rpath,." )
if( WIN32 )
  add_linker_flags_to_target( ${CMAKE_PROJECT_NAME} -Wl,--add-stdcall-alias )
  add_linker_flags_to_target( ${CMAKE_PROJECT_NAME} -Wl,--enable-auto-import )
endif()
