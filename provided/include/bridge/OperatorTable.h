...
#ifndef FACTURATION_BRIDGE_OPERATORTABLE_H
#define FACTURATION_BRIDGE_OPERATORTABLE_H
 ...
 */
extern OperatorTable * (*bridge_OperatorTable_create)(void);

/** Free a table of operators.
 * @param table a pointer to the table to free
 */
extern void (*bridge_OperatorTable_destroy)(OperatorTable * table);
/** Load a table of operators from a file.
 * @param filename the file name
 * @return the new table
 */
extern OperatorTable * (*bridge_OperatorTable_loadFromFile)(const char * filename);

/** Save a table of operators to a file.
 * @param table the table of operators
 * @param filename the file name
 */
extern void (*bridge_OperatorTable_saveToFile)(OperatorTable * table, const char * filename);

/** Get the number of records of a table of operators
 * @param table the table of operators
 * @return the number of records
 */
extern int (*bridge_OperatorTable_getRecordCount)(OperatorTable * table);
 ...
 */
extern const char * (*bridge_OperatorTable_getName)(OperatorTable * table, int recordIndex);
 ...
 */
extern const char * (*bridge_OperatorTable_getPassword)(OperatorTable * table, int recordIndex);
 ...
 */
extern int (*bridge_OperatorTable_findOperator)(OperatorTable * table, const char * name);
 ...
 */
extern int (*bridge_OperatorTable_setOperator)(OperatorTable * table, const char * name,
        const char * password);
 ...
 */
extern void (*bridge_OperatorTable_removeRecord)(OperatorTable * table, int recordIndex);
