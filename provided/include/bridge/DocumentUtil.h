 ...
 *
 * $Id: DocumentUtil.h 293 2011-10-02 15:05:44Z sebtic $
 */

#ifndef FACTURATION_BRIDGE_DOCUMENTUTIL_H
#define FACTURATION_BRIDGE_DOCUMENTUTIL_H

#include <base/DocumentUtil.h>
 ...
 */
extern char * (*bridge_computeDocumentNumber)(long id);
 ...
 * @warning the user is responsible for freeing the memory allocated for the new string
 */
extern char * (*bridge_formatDate)(int day, int month, int year);

/** Write a string in a binary file
 * @param str the string
 * @param file the file
 */
extern void (*bridge_writeString)(const char * str, FILE * file);
 ...
 * @see writeString()
 */
extern char * (*bridge_readString)(FILE * file);
