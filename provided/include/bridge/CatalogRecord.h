...
#ifndef FACTURATION_BRIDGE_CATALOGRECORD_H
#define FACTURATION_BRIDGE_CATALOGRECORD_H
 ...
 */
extern int (*bridge_CatalogRecord_isValueValid_code)(const char * value);

/** Static function which test if the value is a positive number
 * @param  value the value to test
 * @return true if the valie is valid, false otherwise
 */
extern int (*bridge_CatalogRecord_isValueValid_positiveNumber)(const char * value);

/** Static function to set the code field from a string
 * @param record a pointer to the record
 * @param value the value
 */
extern void (*bridge_CatalogRecord_setValue_code)(CatalogRecord * record, const char * value);
 ...
 */
extern void
        (*bridge_CatalogRecord_setValue_designation)(CatalogRecord * record, const char * value);

/** Static function to set the unity field from a string
 * @param record a pointer to the record
 * @param value the value
 */
extern void (*bridge_CatalogRecord_setValue_unity)(CatalogRecord * record, const char * value);

/** Static function to set the basePrice field from a string
 * @param record a pointer to the record
 * @param value the value
 */
extern void (*bridge_CatalogRecord_setValue_basePrice)(CatalogRecord * record, const char * value);

/** Static function to set the sellingPrice field from a string
 * @param record a pointer to the record
 * @param value the value
 */
extern void (*bridge_CatalogRecord_setValue_sellingPrice)(CatalogRecord * record,
        const char * value);
 ...
 * @param value the value
 */
extern void (*bridge_CatalogRecord_setValue_rateOfVAT)(CatalogRecord * record, const char * value);
 ...
 */
extern char * (*bridge_CatalogRecord_getValue_code)(CatalogRecord * record);
 ...
 * @warning the user is responsible for freeing the memory allocated for the new string
 */
extern char * (*bridge_CatalogRecord_getValue_designation)(CatalogRecord * record);
 ...
 * @warning the user is responsible for freeing the memory allocated for the new string
 */
extern char * (*bridge_CatalogRecord_getValue_unity)(CatalogRecord * record);
 ...
 * @warning the user is responsible for freeing the memory allocated for the new string
 */
extern char * (*bridge_CatalogRecord_getValue_basePrice)(CatalogRecord * record);
 ...
 * @warning the user is responsible for freeing the memory allocated for the new string
 */
extern char * (*bridge_CatalogRecord_getValue_sellingPrice)(CatalogRecord * record);
 ...
 * @warning the user is responsible for freeing the memory allocated for the new string
 */
extern char * (*bridge_CatalogRecord_getValue_rateOfVAT)(CatalogRecord * record);
 ...
 */
extern void (*bridge_CatalogRecord_init)(CatalogRecord * record);

/** Finalize a record.
 * @param[in] record a pointer to a record to finalize
 */
extern void (*bridge_CatalogRecord_finalize)(CatalogRecord * record);
 ...
 */
extern void (*bridge_CatalogRecord_read)(CatalogRecord * record, FILE * file);

/** Write a record to a file
 * @param record a pointer to a record
 * @param file the file to which the data are written
 */
extern void (*bridge_CatalogRecord_write)(CatalogRecord * record, FILE * file);
