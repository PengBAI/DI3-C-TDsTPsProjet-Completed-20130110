...
#ifndef FACTURATION_BRIDGE_DOCUMENT_H
#define FACTURATION_BRIDGE_DOCUMENT_H
 ...
 */
extern void (*bridge_Document_init)(Document * document);

/** Finalize a document
 * @param document the document to finalize
 * @warning document must have been initialized
 */
extern void (*bridge_Document_finalize)(Document * document);
 ...
 * @warning document must have been initialized
 */
extern void (*bridge_Document_saveToFile)(Document * document, const char * filename);
 ...
 * @warning document must have been initialized
 */
extern void (*bridge_Document_loadFromFile)(Document * document, const char * filename);
